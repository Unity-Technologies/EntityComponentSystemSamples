...
namespace BootstrappedWorldTests
{
    ...
    {
        /// <summary>
        /// If this test fails either no Systems were found or a System was added which spawns entities by default.
        /// </summary>
        ///
        [UnityTest]
        public IEnumerator DefaultBootstrappedWorldWithAllSystems_WaitingOneFrame_SystemCountIsGreaterZero()
        {
            var world = World.Active;

            yield return new WaitForFixedUpdate();

            Assert.Greater(world.Systems.Count(), 0, "No systems were found");
        }
        ...
        ///
        [UnityTest]
        public IEnumerator DefaultBootstrappedWorldWithAllSystems_WaitingOneFrame_NoEntitiesAreCreated()
        {
            var world = World.Active;
