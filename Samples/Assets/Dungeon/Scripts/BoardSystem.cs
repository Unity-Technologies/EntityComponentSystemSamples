...
namespace Samples.Dungeon.First
{
    ...
    public struct Corridor
    {
        ...
        public static Corridor Setup(Room room, Board board, bool firstCorridor)
        {
            ...
            var direction = (Direction)UnityEngine.Random.Range(0, 4);
...
#pragma warning restore 649
        ...
        private EntityArchetype AttachArchetype;
        ...
        protected override void OnCreateManager()
        {
            ...
            AttachArchetype = EntityManager.CreateArchetype(typeof(Attach));
        }
        ...
        void InstantiateFromArray(NativeArray<Entity> prefabs, float xCoord, float yCoord, Entity parent)
        {
            ...
            EntityManager.AddComponentData(entity, new Static());

            var attach = EntityManager.CreateEntity(AttachArchetype);
