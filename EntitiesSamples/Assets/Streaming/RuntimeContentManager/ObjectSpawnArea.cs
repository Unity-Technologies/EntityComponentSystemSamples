...
{
    //This will create a number of entities within the bounds of the BoxCollider using random meshes and materials from the properties
    //The number of entities is determined by the spacing value
    ...
    public class ObjectSpawnArea : MonoBehaviour
    {
        ...
        class Baker : Baker<ObjectSpawnArea>
        {
            public override void Bake(ObjectSpawnArea authoring)
            {
                ...
                if (authoring.meshes.Count == 0 || authoring.materials.Count == 0)
                    return;
